...
const STORAGE_PREFIX="tokurei-fe-20240128";
const STORAGE={
...
const IMPORTANT_WORDS=[
  ["基礎理論","補数","確率","ビット演算","丸め誤差","論理回路"],
  ["アルゴリズム","スタック","探索表","流れ図"],
  ["コンピュータ","CPI","キャッシュ","入出力制御"],
  ["システム","クライアントサーバ","信頼性","スループット","コールドスタート","SPD"],
  ["ソフトウェア","コンパイラ","OSS"],
  ["マルチメディア","CG技法"],
  ["データベース","データベース","正規化","SQL","JDBC","ロック"],
  ["ネットワーク","伝送時間","ルータ","サブネット","CGI"],
  ["セキュリティ","サイバーキルチェーン","鍵管理","リスクベース認証","セキュリティガバナンス","IPS","ステガノグラフィ","WPA2-PSK"],
  ["開発技術","アクティビティ図","クラス","デザインレビュー","静的解析","リファクタリング","要件定義"],
  ["マネジメント","期待値","スクラムマスター","人月","EVM"],
  ["監査","情報セキュリティ管理基準"],
  ["ストラテジ","To-Beモデル","スマートグリッド","M&A","成長期","BSC","技術のSカーブ","HEMS","コンカレントエンジニアリング","クラウドソーシング","マトリックス組織","定量発注方式"],
  ["品質管理","ヒストグラム"],
  ["会計","限界利益"],
  ["法務","労働者派遣"]
];
